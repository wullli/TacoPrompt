...
class MAGDataset(object):
    def __init__(self, name, path, embed_suffix="", raw=True, existing_partition=False, partition_pattern='internal', shortest_path=True):
...
class RawDataset(Dataset):
    def __init__(self, graph_dataset, mode="train", sampling_mode=1, negative_size=32, max_pos_size=100,
        ...
        self.spdist = graph_dataset.shortest_path
    ...
    def __getitem__(self, idx):
        ...
        if self.sampling_mode == 0:
            ...
            # print(query_node,len(self.node2pos[query_node]))
