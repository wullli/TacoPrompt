...
class RawDataset(Dataset):
    def __init__(self, graph_dataset, mode="train", sampling_mode=1, negative_size=32, max_pos_size=100,
        ...
        if mode == 'train':
            ...
            now_test_node2pos = {self.taxon2id[taxon]: [(self.taxon2id[pos[0]],self.taxon2id[pos[1]]) for pos in poses] for taxon, poses in self.test_node2pos.items()}
            # print(now_test_node2pos)
            # exit()
